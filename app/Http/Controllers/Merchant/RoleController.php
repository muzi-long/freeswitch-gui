...
class RoleController extends Controller
{
    ...
    {
        return View::make('merchant.role.index');
    }
    ...
    {
        $res = Role::where('guard_name','member')->paginate($request->get('limit', 30));
        $data = [
            'code' => 0,
            'msg' => '正在请求中...',
            'count' => $res->total(),
    ...
    {
        return View::make('merchant.role.create');
    }
    ...
    public function store(RoleCreateRequest $request)
    {
        ...
        $data['guard_name'] = 'member';
        try{
            Role::create($data);
            return Redirect::to(URL::route('merchant.role'))->with(['success'=>'添加成功']);
    ...
    public function edit($id)
    {
        ...
        return View::make('merchant.role.edit',compact('role'));
    }
    ...
    public function update(RoleUpdateRequest $request, $id)
    {
        ...
        try{
            $role->update($data);
            return Redirect::to(URL::route('merchant.role'))->with(['success'=>'更新成功']);
        }catch (\Exception $exception){
