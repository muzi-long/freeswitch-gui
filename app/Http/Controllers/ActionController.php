...
class ActionController extends Controller
{
    ...
    public function index(Request $request,$condition_id)
    {
        ...
        return View::make('dialplan.action.index',compact('condition'));
    }
    ...
    {
        $condition = Condition::findOrFail($condition_id);
        return View::make('dialplan.action.create',compact('condition'));
    }
    ...
    public function edit($condition_id,$id)
    {
        ...
        return View::make('dialplan.action.edit',compact('condition','model'));
    }
