...
class MerchantRoleController extends Controller
{
    ...
    {
        return View::make('admin.merchant-role.index');
    }
    ...
    {
        $res = Role::where('guard_name','merchant')->paginate($request->get('limit', 30));
        $data = [
            'code' => 0,
            'msg' => '正在请求中...',
            'count' => $res->total(),
    ...
    {
        return View::make('admin.merchant-role.create');
    }
    ...
    public function store(MerchantRoleRequest $request)
    {
        ...
        try{
            Role::create($data);
            return Redirect::to(URL::route('admin.merchant-role'))->with(['success'=>'添加成功']);
    ...
    public function edit($id)
    {
        ...
        return View::make('admin.merchant-role.edit',compact('role'));
    }
    ...
    public function update(MerchantRoleRequest $request, $id)
    {
        ...
        try{
            $role->update($data);
            return Redirect::to(URL::route('admin.merchant-role'))->with(['success'=>'更新成功']);
        }catch (\Exception $exception){
    ...
    public function permission(Request $request,$id)
    {
        ...
        return View::make('admin.merchant-role.permission',compact('role','permissions'));
    }
