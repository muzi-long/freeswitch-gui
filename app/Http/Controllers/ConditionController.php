...
class ConditionController extends Controller
{
    ...
    public function index(Request $request,$extension_id)
    {
        ...
        return View::make('dialplan.condition.index',compact('extension'));
    }
    ...
    {
        $extension = Extension::findOrFail($extension_id);
        return View::make('dialplan.condition.create',compact('extension'));
    }
    ...
    public function edit($extension_id,$id)
    {
        ...
        return View::make('dialplan.condition.edit',compact('extension','model'));
    }
