...
class ExtensionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return View::make('dialplan.extension.index');
    }

    public function create()
    {
        return View::make('dialplan.extension.create');
    }
    ...
    public function show($id)
    {
        ...
        return View::make('dialplan.extension.show',compact('extension'));
    }
    ...
    public function edit($id)
    {
        ...
        return View::make('dialplan.extension.edit',compact('model'));
    }
