...
class SipController extends Controller
{
    public function index(Request $request)
    {
        ...
        return View::make('sip.index');
    }

    public function create()
    {
        $gateways = Gateway::query()->select(['id', 'name'])->get();
        return View::make('sip.create', compact('gateways'));
    }
    ...
    public function edit($id)
    {
        ...
        return View::make('sip.edit', compact('model', 'gateways'));
    }
    ...
    {
        $gateways = Gateway::select(['id', 'name'])->get();
        return View::make('sip.create_list', compact('gateways'));
    }
