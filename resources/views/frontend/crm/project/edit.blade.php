...
@section('content')
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <form action="{{route('frontend.crm.project.update',['id'=>$model->id])}}" method="post" class="layui-form">
                {{method_field('put')}}
                {{csrf_field()}}
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 400px">
                        <input class="layui-input" type="number" name="contact_phone" lay-verify="required|phone" value="{{$model->contact_phone??old('contact_phone')}}" placeholder="请输入电话">
                    </div>
                </div>
                ...
                @endforeach
                @include('frontend.crm.project._form')
            </form>
        </div>
    </div>
@endsection
