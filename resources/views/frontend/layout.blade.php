    ...
    <div class="layui-layout layui-layout-admin">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="{{route('frontend.system.staff.logout')}}">退出</a></dd>
                    </dl>
                </li>
        ...
        <div class="layui-side layui-side-menu">
            <div class="layui-side-scroll">
                <div class="layui-logo" lay-href="{{route('frontend.index')}}">
                    <span>{{auth()->user()->merchant->company_name??'外呼系统'}}</span>
                </div>
                    ...
                    <li data-name="home" class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="console" class="layui-this">
                                ...
                                <a lay-href="{{route('frontend.index')}}">控制台</a>
                            </dd>
                        </dl>
                        <dl class="layui-nav-child">
                            <dd data-name="console">
                                <i class="layui-icon layui-icon-layouts"></i>
                                <a lay-href="{{route('frontend.index.online')}}">在线拨号</a>
                            </dd>
                        </dl>
                    </li>
        ...
        <div class="layadmin-pagetabs" id="LAY_app_tabs">
            ...
            <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
                <ul class="layui-tab-title" id="LAY_app_tabsheader">
                    <li lay-id="{{route('frontend.index')}}" lay-attr="{{route('frontend.index')}}" class="layui-this"><i class="layui-icon layui-icon-home"></i></li>
                </ul>
            </div>
        </div>
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="{{route('frontend.index')}}" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
