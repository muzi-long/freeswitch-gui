...
<div class="layui-form-item">
    ...
    <div class="layui-input-inline">
        <input class="layui-input" type="text" name="username" lay-verify="required" value="{{$model->username??old('username')}}" placeholder="帐号">
    </div>
</div>
<div class="layui-form-item">
    <label for="" class="layui-form-label">密码</label>
    <div class="layui-input-inline">
        <input class="layui-input" type="password" name="password" @if(!isset($model)) lay-verify="required" @endif value="{{old('password')}}" placeholder="密码">
    </div>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-inline">
        <input class="layui-input" type="text" name="contact_phone" lay-verify="required|phone" value="{{$model->contact_phone??old('contact_phone')}}" placeholder="联系电话">
    </div>
</div>
<div class="layui-form-item">
...
<div class="layui-form-item">
    <div class="layui-input-block">
        ...
        <a href="{{route('home.member')}}" class="layui-btn" >返 回</a>
    </div>
</div>